...
export const ROLE_CONFIG = {
  ...
  [ROLES.NATIONAL_HEAD]: {
    ...
    hierarchyLevel: 'country',
    scope: 'country',
    permissions: [PERMISSIONS.DASHBOARD_READ, PERMISSIONS.KPI_READ, PERMISSIONS.TARGET_READ, PERMISSIONS.EXPORT, PERMISSIONS.AUDIT_READ],
  },
  [ROLES.REGIONAL_MANAGER]: {
    label: ROLE_LABELS[ROLES.REGIONAL_MANAGER],
    hierarchyLevel: 'region',
    scope: 'region',
    permissions: [PERMISSIONS.DASHBOARD_READ, PERMISSIONS.KPI_READ, PERMISSIONS.KPI_CREATE, PERMISSIONS.KPI_UPDATE, PERMISSIONS.TARGET_READ, PERMISSIONS.EXPORT],
  },
  [ROLES.AREA_SALES_MANAGER]: {
    label: ROLE_LABELS[ROLES.AREA_SALES_MANAGER],
    hierarchyLevel: 'territory',
    scope: 'territory',
    permissions: [PERMISSIONS.DASHBOARD_READ, PERMISSIONS.KPI_READ, PERMISSIONS.KPI_CREATE, PERMISSIONS.KPI_UPDATE, PERMISSIONS.TARGET_READ],
  },
  [ROLES.VIEWER]: {
